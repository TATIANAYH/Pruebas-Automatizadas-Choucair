 ...
 */
public class validacionCP1_11 {
    private static WebDriver driver=null;
    public validacionCP1_11() {
    }
    ...
    public void evento_Comments(){
        ...
        driver.get("https://s1.demo.opensourcecms.com/wordpress/wp-admin/post.php?post=1&action=edit");
        ...
        button.click(); 
        WebElement campo = driver.findElement(By.id("post-title-0"));
        campo.sendKeys("Edicion Tatiana Herrera Ing Sistemas");
    }
}
