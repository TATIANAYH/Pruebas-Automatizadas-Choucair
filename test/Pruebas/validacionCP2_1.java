 ...
 */
public class validacionCP2_1 {
    private static WebDriver driver=null;
    public validacionCP2_1() {
    }
    @BeforeClass
    ...
    public void evento_Comments(){
        driver.get("https://s1.demo.opensourcecms.com/wordpress/sample-page/");	
        driver.manage().window().maximize();
        driver.manage().timeouts().implicitlyWait(60, TimeUnit.MINUTES);
        driver.get("https://s1.demo.opensourcecms.com/wordpress/wp-admin/post.php?post=2&action=edit");
